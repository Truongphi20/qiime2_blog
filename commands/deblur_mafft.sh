...
# gdb /workspaces/qiime2_blog/commands/mafft-7.525-with-extensions/build/core/replaceu
...
# gdb /workspaces/qiime2_blog/commands/mafft-7.525-with-extensions/build/core/dndpre
# (gdb) set args -y hat2 -b 62 -M 2 -C 1 < pre     > /dev/null 2>>/dev/null

# /opt/conda/envs/qiime2-amplicon-2026.1/bin/mafft:2693
# gdb /workspaces/qiime2_blog/commands/mafft-7.525-with-extensions/build/core/dvtditr
...
# gdb /workspaces/qiime2_blog/commands/mafft-7.525-with-extensions/build/core/restoreu
